...
body {
  ...
  background-color: rgb(199, 203, 207); /* 背景色を設定 */
    ...
    .previous-button{
      ...
      cursor: pointer;
      font-size: 16px;
      margin-bottom: 10px; /* 下段のボタンにマージンを追加 */
    }
...
<body>
  ...
  <div class="tutorial-container">
    ...
    <button 
      ...
      onclick="location.href='tutorial-1.php'">
      戻る
    </button>
    <button 
      class="next-button" 
   ...
   <!-- 上段に表示したい任意の画像 -->
    <img src= 'tutorial/tutorial-2.1.png' 
      alt="説明用の画像" 
      class="tutorial-image"
    />
    <img src= 'tutorial/tutorial-2.2.png' 
      alt="説明用の画像" 
      class="tutorial-image"
    />
    <img src= 'tutorial/tutorial-2.3.png' 
      alt="説明用の画像" 
      class="tutorial-image"
    />
