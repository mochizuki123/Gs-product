...
//２．つぶやき登録SQL作成
$stmt = $pdo->prepare('SELECT * FROM speech_theme WHERE id=:id;');
    ...
    <header>
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header"><a class="navbar-brand" href="select3.php">スピーチ原稿一覧</a></div>
        ...
        <div class="jumbotron">
            <fieldset>
                ...
                <div>
                    ...
                    <textarea id="content" name="content" rows="60" cols="100"><?= h($row['text_theme']) ?></textarea>
                </div>
