...
// upload2.php が menu2.php にリダイレクトする際に、title や outline を GET パラメータに追加
header("Location: menu2.php?response=" . urlencode($response_text) .
    "&title=" . urlencode($title) .
    "&message=" . urlencode($message) .
    "&outline1=" . urlencode($outline1) .
    "&outline2=" . urlencode($outline2) .
    "&outline3=" . urlencode($outline3) .
    "&outline4=" . urlencode($outline4));
