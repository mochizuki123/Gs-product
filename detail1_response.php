    ...
    <header>
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header"><a class="navbar-brand" href="select1.php">スピーチ原稿一覧</a></div>
        ...
        <div class="jumbotron">
            <fieldset>
                ...
                <div>
                    ...
                    <textarea id="content" name="content" rows="60" cols="100"><?= h($row['response_prompt']) ?></textarea>
                </div>
